...
public class ManageRequestMoviesFragment extends Fragment {
    ...
    //Recycler view
    private List<ManageMovieRequestResponse>            mManageRequestList;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private boolean isSwipeOn = false;
    private RecyclerView                                mManageRequestRecyclerView;
    private ManageRequestRecyclerAdapter                mManageRequestAdapter;

    //Retrofit
    private Call<ManageMovieRequestResponsePaging>      mManageRequestMoviesCall;
    ...
    private void intAdapter() {
        ...
        mManageRequestList = new ArrayList<ManageMovieRequestResponse>();

        mManageRequestRecyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_manage_request_fragment);
        mManageRequestAdapter = new ManageRequestRecyclerAdapter(getContext(), mManageRequestList);
        ...
        mManageRequestAdapter.setOnSubscribeButtonClickListener(new ManageRequestRecyclerAdapter.OnSubscribeButtonClickListener() {
            @Override
...
//        });
    ...
    private void loadRequestMovies() {
        ...
        mManageRequestMoviesCall = ApiClient.getRetrofitApi().getRequestMovies(presentPage, mMyGoogleAccountInfo.getId(), mStatus);

        mManageRequestMoviesCall.enqueue(new Callback<ManageMovieRequestResponsePaging>() {
            @Override
            public void onResponse(Call<ManageMovieRequestResponsePaging> call, Response<ManageMovieRequestResponsePaging> response) {
            ...
            @Override
            public void onFailure(Call<ManageMovieRequestResponsePaging> call, Throwable t) {
        ...
        private void mangRequestMovie(String movieId,String userGId,int storeId,String status,int position,String msg){
            ...
            Call<QuerryResponse>  mRequestMovieMoviesCall = ApiClient.getRetrofitApi().mangRequestMovieRent
            ...
            mRequestMovieMoviesCall.enqueue(new Callback<QuerryResponse>() {
                ...
                public void onResponse(Call<QuerryResponse> call, Response<QuerryResponse> response) {
                    ...
                    if(!mStatus.equals(status)) {
                      ...
                      //  mManageRequestRecyclerView.findViewHolderForAdapterPosition(position).itemView.pr;
                      // mManageRequestAdapter.getHolder(position).mProgressBar.setVisibility(View.GONE);
