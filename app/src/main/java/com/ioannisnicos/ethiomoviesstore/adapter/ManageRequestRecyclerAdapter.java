...
public class ManageRequestRecyclerAdapter extends RecyclerView.Adapter<ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder> {
    ...
    //HashMap<Integer,ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder > mHolderMap=new HashMap<Integer,ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder>();
    ...
    public ManageRequestRecyclerAdapter(Context context, List<ManageMovieRequestResponse> manageRequestList) {
        mContext = new WeakReference<Context>(context);
        mManageRequestList = manageRequestList;
    }

    @Override
    public ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder(LayoutInflater.from(mContext.get()).inflate(R.layout.card_manage_request_large, parent, false));
    }

    @Override
    public void onBindViewHolder(ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder holder, int position) {
        ...
        if (mManageRequestList.get(position).getStatus().getMovie_status().equals("yes"))
...
//    public ManageRequestRecyclerAdapter.ManageRequestRecyclerAdapterViewHolder getHolder(int position) {
