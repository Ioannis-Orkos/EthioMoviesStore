...
public class Stores implements Parcelable {
    ...
    public Stores(int id, String google_id, String notif_token, String first_name, String last_name, String display_name, String email, String language, String prof_img, String banner, String description, String business_name, String address, String postcode, double geolng, double geolat, String reg_date) {
        this.id = id;
